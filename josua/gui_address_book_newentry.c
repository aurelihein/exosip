...
window_address_book_newentry_print ()
{
  ...
  attrset (COLOR_PAIR (1));
  snprintf (buf, x - gui_window_address_book_newentry.x0, "SIP url : ");
  mvaddnstr (gui_window_address_book_newentry.y0,
             gui_window_address_book_newentry.x0,
             buf, x - gui_window_address_book_newentry.x0 - 1);
  snprintf (buf, x - gui_window_address_book_newentry.x0, "TEL url : ");
  mvaddnstr (gui_window_address_book_newentry.y0 + 1,
             gui_window_address_book_newentry.x0,
             buf, x - gui_window_address_book_newentry.x0 - 1);
  snprintf (buf, x - gui_window_address_book_newentry.x0, "Email   : ");
  mvaddnstr (gui_window_address_book_newentry.y0 + 2,
             gui_window_address_book_newentry.x0,
             buf, x - gui_window_address_book_newentry.x0 - 1);
  snprintf (buf, x - gui_window_address_book_newentry.x0, "Phone   : ");
  mvaddnstr (gui_window_address_book_newentry.y0 + 3,
             gui_window_address_book_newentry.x0,
             buf, x - gui_window_address_book_newentry.x0 - 1);
...
int
window_address_book_newentry_run_command (int c)
{
  int y, x;
  ...
  switch (c)
    {
      ...
      case KEY_UP:
        ...
        break;
      case KEY_RIGHT:
        if (gui_window_address_book_newentry.xcursor <
      ...
      case 1:                  /* Ctrl-A */
        {
          ...
          mvinnstr (ycur, xcur, sipurl,
                    x - gui_window_address_book_newentry.x0 - 10);
          ycur++;
          mvinnstr (ycur, xcur, telurl,
                    x - gui_window_address_book_newentry.x0 - 10);
          ycur++;
          mvinnstr (ycur, xcur, email,
                    x - gui_window_address_book_newentry.x0 - 10);
          ycur++;
          mvinnstr (ycur, xcur, phone,
                    x - gui_window_address_book_newentry.x0 - 10);
      ...
      case 4:                  /* Ctrl-D */
        {
          ...
          mvaddnstr (gui_window_address_book_newentry.y0 +
                     gui_window_address_book_newentry.ycursor,
                     gui_window_address_book_newentry.x0 + 10, buf,
